...
KVals="2 3 4";                   # is a quoted string (like \"2 3 5 7\") of different K values
                                   # at which to run structure.
StructReps="5 5 5"                     # should be  either: 
...
StructNumBurnIn=20000;             # number of structure Burn In Sweeps
StructNumSweep=50000;             # number of data collection sweeps.
